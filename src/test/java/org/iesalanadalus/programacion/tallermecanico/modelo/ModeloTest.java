...
import org.iesalanadalus.programacion.tallermecanico.modelo.negocio.*;
import org.iesalanadalus.programacion.tallermecanico.modelo.negocio.ficheros.Clientes;
import org.iesalanadalus.programacion.tallermecanico.modelo.negocio.ficheros.Trabajos;
...
class ModeloTest {
    ...
    void modificarClienteLlamaClientesModificar() {
        Assertions.assertDoesNotThrow(() -> modelo.modificar(cliente, "Patricio Estrella", "950123456"));
