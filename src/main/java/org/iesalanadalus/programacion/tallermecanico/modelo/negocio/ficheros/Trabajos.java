...
public class Trabajos implements ITrabajos {
    ...
    private static final String FICHERO_TRABAJOS = String.format("%s%s%s", "datos\\ficheros", File.separator, "trabajos.xml");
    ...
    private Trabajo getTrabajo(Element elemento) throws OperationNotSupportedException {
        org.iesalanadalus.programacion.tallermecanico.modelo.dominio.Cliente cliente = org.iesalanadalus.programacion.tallermecanico.modelo.dominio.Cliente.get(elemento.getAttribute(CLIENTE));
    ...
    @Override
    public List<Trabajo> get(org.iesalanadalus.programacion.tallermecanico.modelo.dominio.Cliente cliente) {
