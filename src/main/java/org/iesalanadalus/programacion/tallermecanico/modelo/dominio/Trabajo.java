...
public abstract class Trabajo {
    ...
    private org.iesalanadalus.programacion.tallermecanico.modelo.dominio.Cliente cliente;
    ...
    protected Trabajo(org.iesalanadalus.programacion.tallermecanico.modelo.dominio.Cliente cliente, Vehiculo vehiculo, LocalDate fechaInicio) {
        setCliente(cliente);
    ...
    protected Trabajo(Trabajo trabajo) {
        ...
        cliente = new org.iesalanadalus.programacion.tallermecanico.modelo.dominio.Cliente(trabajo.cliente);
    ...
    public static Trabajo get(Vehiculo vehiculo) {
        ...
        return new Revision(org.iesalanadalus.programacion.tallermecanico.modelo.dominio.Cliente.get("11111111H"), vehiculo, LocalDate.now());
    }
